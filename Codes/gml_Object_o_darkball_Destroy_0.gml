if instance_exists(owner)
{
    if is_player(owner)
    {
        ...
        if (!(scr_instance_exists_in_list(o_b_angel_charm, o_player.buffs)))
            scr_temp_effect_update(object_index, 3226, "Unholy_Damage", (Unholy_Damage / 3), 12, 1)
        else
            scr_temp_effect_update(object_index, 3226, "Sacred_Damage", (Unholy_Damage / 3), 12, 1)
        scr_allturn()
    }
}
