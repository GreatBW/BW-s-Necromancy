...
";
    ...
    private static IEnumerable<string> BooksIterator(IEnumerable<string> input)
    {
        ...
        string grimoir1_mid_en = @"\""The Forbidden Sigil: Unveiling magic through proper rituals.\""##~gr~Allows you to learn the following Occultism abilities:~/~##~lg~Desecration~/~#~lg~Painful Curse~/~#~lg~Essence Charge~/~##Reading this book grants some ~y~Experience~/~.";
